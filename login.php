...
if(isset($_POST['logsubmit']))
{
    ...
    $sel=mysqli_query($conn,"select * from users where Email='$lemail' ");
    $arr=mysqli_fetch_assoc($sel);
...
<main class="container row">
    ...
    <form class="mt-5" style="width:700px;" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <input type="text" name="logemail" class="form-control" placeholder="EMAIL" id='mailid' onblur="return myFunction()">
        </div>
